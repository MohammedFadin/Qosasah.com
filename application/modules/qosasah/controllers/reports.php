...
class reports extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Qosasah.Reports.View');
	...
	{
		$this->auth->restrict('Qosasah.Reports.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_qosasah())
			{
				...
				redirect(SITE_AREA .'/reports/qosasah');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Qosasah.Reports.Edit');
		...
		{
			$this->auth->restrict('Qosasah.Reports.Delete');
