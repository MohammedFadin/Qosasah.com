...
class developer extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Qosasah.Developer.View');
	...
	{
		$this->auth->restrict('Qosasah.Developer.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_qosasah())
			{
				...
				redirect(SITE_AREA .'/developer/qosasah');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Qosasah.Developer.Edit');
		...
		{
			$this->auth->restrict('Qosasah.Developer.Delete');
