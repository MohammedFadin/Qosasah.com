...
class content extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Qosasah.Content.View');
	...
	{
		$this->auth->restrict('Qosasah.Content.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_qosasah())
			{
				...
				redirect(SITE_AREA .'/content/qosasah');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Qosasah.Content.Edit');
		...
		{
			$this->auth->restrict('Qosasah.Content.Delete');
