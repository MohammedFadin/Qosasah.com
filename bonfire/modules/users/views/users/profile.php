...
?>
    <div class="container-fluid well" style="padding-top:50px; padding-bottom:10%">   
      <div class="row">
        <div class="col-md-10 col-md-offset-1">
          <div class="panel panel-default">
            <div class="panel-heading">
              <h3 class="panel-title text-right">إعدادات الحساب</h3>
            </div>                
            <div class="panel-body">
              ...
              <?php echo form_open($this->uri->uri_string(), array('class' => 'form-horizontal', 'autocomplete' => 'off')); ?>
                <fieldset class="text-right">
                    ...
                    <label for="country" class="col-md-2">مكان الإقامة</label>
                        <div class="col-md-10">
                    ...
                    <div class="col-sm-2 col-md-offset-2">
                        <button class="btn btn-success" type="submit" name="save">تحديث</button>
                    </div>
                </fieldset>
              <?php form_close();?>
            </div>
