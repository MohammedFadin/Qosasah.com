        ...
        <div class="col-md-4 col-md-offset-4">
          <div class="panel panel-default">
            <div class="panel-heading">
              <h3 class="panel-title text-center">حساب جديد</h3>
            </div>
            <div class="panel-body">
             <?php echo form_open( site_url(REGISTER_URL), array('autocomplete' => 'off')); ?>
                <fieldset class="text-right" dir="rtl">
                  ...
                  <div class="form-group">
                    <label for="display_name">الإسم المستعار</label>
                    <input class="form-control text-right" placeholder name="display_name" type="display_name" value>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="email">إعادة إدخال كلمة المرور</label>
                    <input class="form-control text-right required" placeholder name="pass_confirm" type="password" value>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="country">مكان الإقامة</label>
